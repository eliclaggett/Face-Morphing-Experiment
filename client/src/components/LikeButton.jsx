...
import { ThumbDown, ThumbDownOutlined, ThumbDownRounded, ThumbUpAlt, ThumbUpOutlined, ThumbUpRounded } from '@mui/icons-material';
...
export default function LikeButton({setHolding, name}) {
  ...
  return (
    <div className={likeClass}>
        <Button startDecorator={<ThumbUpAlt />} className='likeBtn' onMouseDown={handleMouseDown} onMouseUp={handleMouseUp} >Like</Button>
    </div>
  );
}
