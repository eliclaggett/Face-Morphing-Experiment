        ...
        return (<div>
            <FormControl>
                ...
                <RadioGroup
                    ...
                    onChange={onChange}
                >
                    <LikertButton label="Very weakly" value="0" disabled={disabled} />
                    <LikertButton label="Weakly" value="1" disabled={disabled} />
                    <LikertButton label="Slightly weakly" value="2" disabled={disabled} />
                    <LikertButton label="Average" value="3" disabled={disabled} />
                    <LikertButton label="Slightly strongly" value="4" disabled={disabled} />
                    <LikertButton label="Strongly" value="5" disabled={disabled} />
                    <LikertButton label="Very strongly" value="6" disabled={disabled} />
                </RadioGroup>
            </FormControl>
        </div>);
    }
